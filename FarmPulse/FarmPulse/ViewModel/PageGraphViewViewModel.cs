...
namespace FarmPulse.ModelView
{
    public class PageGraphViewViewModel : BaseModel
    {
        ...
        public string TextSelectedMetrics { get => GetValue<string>(); set => SetValue(value); }  
        ...
        public PageGraphViewViewModel()
        {
            ...
            ShowBox = false;
            TextSelectedMetrics = "NDVI";
            TextSelectedMetrics = RSC.SelectIndex;
        ...
        public async void GetIndexList()
        {
            ...
            if (MetricsList.Count != 0)
            {
                ...
                TextSelectedMetrics = SelectedMetrics.name;
